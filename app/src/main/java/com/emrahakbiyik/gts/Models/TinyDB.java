...
public class TinyDB {
    ...
    public ArrayList<Object> getListObject(String key, Type typ) {
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            Object value = gson.fromJson(jObjString, typ);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putObjectImmediately(String key, Object obj) {
        checkForNullKey(key);
        Gson gson = new Gson();
        putStringImmediately(key, gson.toJson(obj));
    }
